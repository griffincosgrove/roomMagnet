            ...
            <div class="row">
              <div class="col-md-4 d-md-flex align-items-md-start flex-md-column mb-5 mb-md-0">
                ...
                <a class="js-fancybox u-media-viewer mb-3" href="javascript:;"
                   ...
                   data-speed="700"
                   data-is-infinite="true">
                  <img class="img-fluid w-100" src="../../assets/img/480x320/img20.jpg" alt="Image Description">

                  <div class="position-absolute bottom-0 right-0 pb-2 pr-2">
                    <span class="btn btn-icon btn-sm btn-white" title="Equity Property">
                      <span class="fas fa-images btn-icon__inner"></span>
                    </span>
                  </div>
                </a>
                ...
                <!-- Agent Info -->
                <div class="media align-items-center mt-auto">
                  <span class="btn btn-icon btn-sm btn-soft-success rounded-circle mr-2">
            ...
            <div class="row">
              <div class="col-md-4 d-md-flex align-items-md-start flex-md-column mb-5 mb-md-0">
                ...
                <a class="js-fancybox u-media-viewer mb-3" href="javascript:;"
                   ...
                   data-speed="700"
                   data-is-infinite="true">
                  <img class="img-fluid w-100" src="../../assets/img/480x320/img21.jpg" alt="Image Description">
            ...
            <div class="row">
              <div class="col-md-4 d-md-flex align-items-md-start flex-md-column mb-5 mb-md-0">
                ...
                <a class="js-fancybox u-media-viewer mb-3" href="javascript:;"
                   ...
                   data-speed="700"
                   data-is-infinite="true">
                  <img class="img-fluid w-100" src="../../assets/img/480x320/img22.jpg" alt="Image Description">
            ...
            <div class="row">
              <div class="col-md-4 d-md-flex align-items-md-start flex-md-column mb-5 mb-md-0">
                ...
                <a class="js-fancybox u-media-viewer mb-3" href="javascript:;"
                   ...
                   data-speed="700"
                   data-is-infinite="true">
                  <img class="img-fluid w-100" src="../../assets/img/480x320/img23.jpg" alt="Image Description">

                  <div class="position-absolute bottom-0 right-0 pb-2 pr-2">
                    <span class="btn btn-icon btn-sm btn-white" title="Monica Fox">
                      <span class="fas fa-images btn-icon__inner"></span>
                    </span>
                  </div>
                </a>
