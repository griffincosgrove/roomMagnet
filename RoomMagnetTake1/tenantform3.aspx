<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantform3.aspx.cs" Inherits="tenantform3" %>
    ...
    <div class="bg-light">
      <div class="container space-2 space-md-3">
        ...
        <img class="px-lg-3 pb-6" width="250" src="images/info3.png">
                ...
                <p class="col-6">Your basic profile has been created and your property results are being generated. Feel free to visit your profile settings and add more information later.</p>
              </div> 
              <!-- End Title -->

 <a class="btn btn-sm btn-soft-primary transition-3d-hover" href="tenantdashboard.aspx">
