<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateProperty.aspx.cs" Inherits="updateProperty" %>
...
<!-- Icon Blocks Section -->
    <div class="bg-light">
      <div class="container space-2 space-md-3">
        ...
        <img class="px-lg-3 pb-6" width="250" src="images/info2.png">
                ...
                <div class="mb-7">
                  <h1 class="sunset font-weight-semi-bold asap2 col-8"><strong>Update Listing </strong><span class="h3 opensans display-5 navy font-weight-normal ml-1"></span></h1>
    ...
    <form class="js-validate" runat="server" enctype="multipart/form-data">
                            <div>
                                <asp:Label Text="Select a Property to Update" runat="server" />
                                            <asp:DropDownList ID="ddProperty" runat="server" DataSourceID="SqlDataSource1" DataTextField="Address" DataValueField="PropertyID" AppendDataBoundItems="True">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RoomMagnetDBConnectionString %>" SelectCommand="SELECT [Address], [PropertyID] FROM [Property] WHERE ([HostID] = @HostID)">
                        <selectparameters>
