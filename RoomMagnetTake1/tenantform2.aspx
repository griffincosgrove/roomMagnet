<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantform2.aspx.cs" Inherits="tenantform2" %>
                    ...
                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse opensans">
                        <ul class="navbar-nav u-header__navbar-nav">
                                                ...
                                                <div class="u-header__promo-card u-header__promo-item">
                                                    <a class="u-header__promo-link" href="#tenant">
                                                        <div class="media align-items-center">
                                                            <img class="u-header__promo-icon" src="images/tenant2.svg" alt="SVG">
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-6 u-header__promo-footer-ver-divider">
                                                <div class="u-header__promo-footer-item">
                                                    ...
                                                    <a class="small" href="http://htmlstream.com/contact-us">Contact us
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li class="nav-item u-header__nav-last-item">
                                <a class="btn btn-sm btn-primary transition-3d-hover" href="login.aspx">Log In
                                </a>
                            </li>
                            <!-- End Button -->
                            <!-- Button -->
                            <li class="nav-item u-header__nav-last-item">
                                <a class="btn btn-sm btn-primary transition-3d-hover" href="signup.aspx">Sign Up
                                </a>
                            </li>
                            <!-- End Button -->
                        </ul>
        ...
        <div class="bg-light">
            ...
            <span class="text-danger">*</span>
                  ...
                  <span class="text-danger">*</span>
                        ...
                        <a class="btn btn-sm btn-primary transition-3d-hover mr-1" href="tenantform3.aspx">Next Step!
