      ...
      <div class="row">
          ...
          <div class="card-deck d-block d-md-flex">
            ...
            <div class="card mb-5">
              ...
              <a class="js-fancybox u-media-viewer" href="javascript:;"
                ...
                <img class="card-img-top w-100" src="images/room1.jpg" alt="Image Description">
                ...
                <div class="position-absolute bottom-0 left-0 right-0 pb-2 px-3">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-8">
                      <h2 class="h5 text-white mb-0">$300/mo</h2>
                    </div>
              ...
              <div class="card-body p-4">
                ...
                <div class="media align-items-center border-top border-bottom py-3 mb-3">
                  ...
                  <div class="media-body">
                    <small class="d-block text-muted">Listed on April 5, 2019 by</small>
              ...
              <div class="card-body p-4">
                ...
                <div class="media align-items-center border-top border-bottom py-3 mb-3">
                  <span class="btn btn-icon btn-soft-success rounded-circle mr-3">
                    <img class="img-fluid rounded-circle" src="images/elder4.jpg" alt="Image Description" title="Natalie Curtis">
                  </span>
                  <div class="media-body">
                    <small class="d-block text-muted">Listed on Jan 4, 2019 by</small>
                    <span class="d-block">Natalie Curtis</span>
                  </div>
                </div>
                <!-- End Posted Info -->
          ...
          <div class="card-deck d-block d-md-flex">
            ...
            <div class="card mb-5">
              ...
              <a class="js-fancybox u-media-viewer" href="javascript:;"
                 ...
                 data-speed="700"
                 data-is-infinite="true">
                <img class="card-img-top w-100" src="images/room3.jpg" alt="Image Description">
                ...
                <div class="position-absolute bottom-0 left-0 right-0 pb-2 px-3">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-8">
                      <h4 class="h5 text-white mb-0">$450/mo</h4>
                    </div>
              ...
              <div class="card-body p-4">
                ...
                <div class="media align-items-center border-top border-bottom py-3 mb-3">
                  ...
                  <div class="media-body">
                    <small class="d-block text-muted">Listed on March 6, 2019 by</small>
            ...
            <div class="card mb-5">
              ...
              <a class="js-fancybox u-media-viewer" href="javascript:;"
                 ...
                 data-speed="700"
                 data-is-infinite="true">
                <img class="card-img-top w-100" src="images/room4.jpg" alt="Image Description">
                ...
                <div class="position-absolute bottom-0 left-0 right-0 pb-2 px-3">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-8">
                      <h4 class="h5 text-white mb-0">$400/mo</h4>
                    </div>
        ...
        <div class="col-lg-4">
          ...
          <!-- Indicator -->
              <!-- Title & Settings -->
              <div class="d-flex justify-content-between align-items-center">
                <h4 class="h6 mb-0">Saved Properties</h4>
