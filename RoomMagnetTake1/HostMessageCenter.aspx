<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HostMessageCenter.aspx.cs" Inherits="HostMessageCenter" %>
                ...
                <form class="js-validate" runat="server">
                  ...
                  <span class="text-danger">*</span>
                    ...
                    <!-- Buttons -->
                                                         ...
                                                         <asp:Button ID="btnSendMsgToTenant" runat="server" Text="Send Message" class="btn btn-sm btn-soft-primary transition-3d-hover" OnClick="btnSendMsgToTenant_Click" />

                    <asp:Button ID="btnVideo" class="btn btn-sm btn-soft-primary transition-3d-hover" runat="server" Text="Video Chat!"  OnClick="btnVideo_Click"/>
                    <!-- End Buttons -->
