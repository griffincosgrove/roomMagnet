            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <asp:TextBox ID ="txtLocation" runat="server" class="form-control" name="location" value="" placeholder="Street, city, state, zip code" aria-label="Street, city, state, zip code" required aria-describedby="locationLabel"
...
<div class="col-sm-2 mb-6">
            ...
            <div class="col-sm-6 mb-6">
              ...
              <div class="js-form-message">
                <label id="neighborhoodLabel" class="form-label">
                  Neighborhood
                  <span class="text-danger">*</span>
                </label>
