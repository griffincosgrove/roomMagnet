      ...
      <div class="container space-2 space-md-3">
        <!-- Form -->
            <form class="js-validate mt-5">
              <!-- Title -->
        &nbsp;<div class="mb-7">
                  <h1 class="sunset font-weight-semi-bold asap2 col-8"><strong>Your Profile </strong><span class="h3 opensans display-5 navy font-weight-normal ml-1">Update your information!</span></h1>
                <p class="col-6"></p>
              </div>
                </form>
              <!-- End Title -->
          <!-- Profile Picture -->
          <img class="px-lg-3 pb-6" width="250" src ="">
...
<asp:TextBox ID="txtDescription" runat="server" class="form-control" name="description" value="" placeholder="Write a description of your place" aria-label="Write a description of your place" required aria-describedby="descriptionLabel"
            ...
            <asp:Button ID="btnCommitProperty" runat="server" Text="Next Step!" type="submit" class="btn btn-primary transition-3d-hover"/>
